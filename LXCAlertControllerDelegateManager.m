//
//  LXCBaseAlertControllerDelegateManager.m
//  LXCAlertController
//
//  Created by 刘晓晨 on 2019/5/10.
//

#import "LXCBaseAlertControllerDelegateManager.h"
#import "LXCBaseAlertController.h"

@interface LXCBaseAlertControllerDelegateManager ()

@property (nonatomic, assign) BOOL isPresenting;

@end

@implementation LXCBaseAlertControllerDelegateManager
...
- (void)presentAnimationTransition:(id<UIViewControllerContextTransitioning>)transitionContext {
    ELBaseAlertController *alertController = (ELBaseAlertController *)[transitionContext viewControllerForKey:UITransitionContextToViewControllerKey];
...
- (void)dismissAnimationTransition:(id<UIViewControllerContextTransitioning>)transitionContext {
    ELBaseAlertController *alertController = (ELBaseAlertController *)[transitionContext viewControllerForKey:UITransitionContextFromViewControllerKey];
    [UIView animateWithDuration:0.25 animations:^{
        alertController.backgroundView.alpha = 0.0;
        alertController.alertView.alpha = 0.0;
